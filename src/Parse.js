...
_.forEach(CONSTANTS, function(fn, constantName) {
        fn.constant = fn.literal = fn.sharredGetter = true;
    }
);
...
var ensureSafeObject = function (obj) {
    if (obj) {
        if (obj.document && obj.location && obj.alert && obj.setInterval) {
            ...
            throw 'Referencing Functions in Angular expressions is disallowed';
...
Parser.prototype.binaryFn = function(left, op, right, shortCircuiting) {
    var fn = function(self, locals) {
        return op(self, locals, left, right);
    };
    fn.constant = left.constant && right.constant;
    fn.inputs = !shortCircuiting && [left, right];
    return fn;
};
